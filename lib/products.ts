...
export const products: Product[] = [
  // ── SMOKE ALARMS ──────────────────────────────────────────────────────────
  {
    ...
    imageUrl: "/services/Smoke Alarms(AS 3786).png",
  ...
  // ── FIRE EXTINGUISHERS & SIGNAGE ──────────────────────────────────────────
  {
    ...
    imageUrl: "/services/Fire extinguishers.jpg",
  ...
  // ── EMERGENCY LIGHTS & EXIT SIGNS ─────────────────────────────────────────
  {
    ...
    colors: [{ label: "White", value: "white" }],
    imageUrl: "/services/emergencylights.jpg",
  ...
  // ── DIESEL PUMP & HYDRANT ──────────────────────────────────────────────────
  {
    ...
    colors: [],
    imageUrl: "/services/diesel hydrant.jpg",
  ...
  // ── AIR & MECHANICAL SERVICES ──────────────────────────────────────────────
  {
    ...
    colors: [],
    imageUrl: "/services/mechanical.jpg",
  ...
  // ── FLOW TESTING ──────────────────────────────────────────────────────────
  {
    ...
    colors: [],
    imageUrl: "/services/flowtest.jpg",
  ...
  // ── SERVICE PENETRATION & FIRE DAMPERS ────────────────────────────────────
  {
    ...
    colors: [],
    imageUrl: "/services/passivefire.jpg",
  ...
  // ── FIRE PANEL & DETECTION (AS 1670.1) ────────────────────────────────────
  {
    ...
    colors: [{ label: "Red", value: "red" }],
    imageUrl: "/services/Fire Panel &Detection (AS 1670.1).jpg",
  ...
  // ── FIRE DOORS ─────────────────────────────────────────────────────────────
  {
    ...
    colors: [],
    imageUrl: "/services/firedoor.jpg",
  ...
  // ── PLANS & EVACUATION ────────────────────────────────────────────────────
  {
    ...
    colors: [],
    imageUrl: "/services/zoneblockplan.jpg",
    categoryId: "plans",
    tag: 'Service',
  },
  {
  ...
  // ── FIRE HOSE REELS — new category listings ────────────────────────────
  {
    ...
    colors: [{ label: "Red", value: "red" }],
    imageUrl: "/services/firehose.png",
