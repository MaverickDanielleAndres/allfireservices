                    ...
                    <div className="contact-cta_info-wrapper" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', alignItems: 'flex-start', textAlign: 'left', padding: 0, margin: 0, width: '100%' }}>
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', width: '100%', marginTop: '0.25rem' }}>
                        ...
                        <ul className="contact-social-links" style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-start', width: '100%', listStyle: 'none', padding: 0, margin: 0 }}>
                          <li><a className="contact-social-link" href="https://facebook.com/allfireservices" rel="noopener noreferrer" target="_blank" aria-label="Facebook (opens in a new tab)" style={{ color: '#1A1A1A', transition: 'color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.color = '#FEAF04'} onMouseOut={(e) => e.currentTarget.style.color = '#1A1A1A'}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg></a></li>
                          ...
                          <li><a className="contact-social-link" href="https://x.com/allfireservices" rel="noopener noreferrer" target="_blank" aria-label="X (opens in a new tab)" style={{ color: '#1A1A1A', transition: 'color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.color = '#FEAF04'} onMouseOut={(e) => e.currentTarget.style.color = '#1A1A1A'}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M4 4l11.733 16h4.267l-11.733 -16z" /><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772" /></svg></a></li>
                          <li><a className="contact-social-link" href="https://www.linkedin.com/company/all-fire-services-australia" rel="noopener noreferrer" target="_blank" aria-label="LinkedIn (opens in a new tab)" style={{ color: '#1A1A1A', transition: 'color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.color = '#FEAF04'} onMouseOut={(e) => e.currentTarget.style.color = '#1A1A1A'}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg></a></li>
                          ...
                          <li><a className="contact-social-link" href="https://instagram.com/allfireservices" rel="noopener noreferrer" target="_blank" aria-label="Instagram (opens in a new tab)" style={{ color: '#1A1A1A', transition: 'color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.color = '#FEAF04'} onMouseOut={(e) => e.currentTarget.style.color = '#1A1A1A'}><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="contact-cta_form-block w-form">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            I accept the{" "}
                            <Link href="/contact" className="text-style-link" style={{ color: '#111111', fontWeight: 500 }}>
                              Terms
                            </Link>
                          </span>
                        </label>
