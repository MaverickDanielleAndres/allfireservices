...
export function GalleryImage({
  ...
  return (
    <motion.div
      ...
      whileTap="tap"
      className={cn(
        "relative cursor-zoom-in rounded-xl overflow-hidden block aspect-[4/3]",
        className
      )}
...
function GalleryModal() {
  ...
  return (
    <AnimatePresence>
      {selectedImage && (
        <div className="fixed inset-0 z-[90] flex items-center justify-center pt-[100px] pb-6 px-4">
          ...
          >
            ...
            <motion.img
              ...
              className="w-auto h-auto max-w-full max-h-[calc(100vh-140px)] rounded-xl shadow-2xl object-contain will-change-transform"
          ...
          <motion.button
            ...
            className="absolute top-[110px] right-6 z-50 p-2.5 bg-black/50 text-white rounded-full backdrop-blur-md hover:bg-black/70 transition-colors"
            onClick={() => setSelectedImage(null)}
