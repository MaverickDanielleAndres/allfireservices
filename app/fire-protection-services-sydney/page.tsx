                  ...
                  <div className="process_list">
                      ...
                      <div className="process_item">
                        ...
                        <div className="process_content-right">
                          ...
                          <div className="process_text-wrap">
                            <h2 className="heading-style-h6">Complete Fire Protection</h2>
                            <p className="body-text">Our solutions include fire alarm installations, fire extinguisher servicing, emergency lighting systems, and detailed risk assessments.</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="process_item">
                        ...
                        <div className="process_content-right">
                          ...
                          <div className="process_text-wrap">
                            <h2 className="heading-style-h6">Expert Team</h2>
                            <p className="body-text">Staffed by professional, experienced firefighters who bring invaluable knowledge and skill to every service we provide.</p>
                          </div>
                        </div>
                      </div>
                        </div>
